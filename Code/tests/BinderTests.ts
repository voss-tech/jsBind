...
module jsBind {
    ...
    class TestBinder extends Binder {
        constructor(expr: string) {
            ...
            element.setAttribute("data-jsBind", expr);

            super(element, this, null);
        }
...
//                ["foo\\u00D8bar;", '12 identifier unicode escape'],
                ...
                ["$d.values['m'];", "2 member expression"],
                ["$d.values['n']['m'];", "3 member expression"],
                ...
                //["$d instanceof string;", "16 expression expressions"],
            ...
            for (var i = 0; i < inps.length; ++i) {
                try {
                    var binder = new TestBinder("prop:val=" + inps[i][0]);
                } catch(e) {
